...
public class mainGameScreen implements Screen
{
    ...
    public void render(float delta)
    {
        ...
        if(car.getX() > touchX && touchX != 0)
        {
            car.moveLeft();
        }
        else if(car.getX() < touchX && touchX != 0)
        {
            car.moveRight();
        }
        ...
        batch.draw(road3,0,roadY+road1.getHeight()+road0.getHeight(), game.getScreenWidth(),game.getScreenHeight());
